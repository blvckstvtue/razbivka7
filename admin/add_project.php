...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validation
    if (empty($project_id)) $errors[] = 'Project ID е задължително поле';
    ...
    if (!empty($project_id)) {
        $existing = $projectManager->getProjectByProjectId($project_id);
        if ($existing) {
    ...
    if (empty($errors)) {
        try {
            ...
            $errors[] = 'Грешка при създаване на проекта: ' . $e->getMessage();
        }
    }
}
?>
...
<head>
    ...
    <title>Добави проект - Админ панел</title>
...
<body>
    ...
    <div class="container">
        <h1 class="page-title">Добави нов проект</h1>
            ...
            <form method="post">
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Създай проект
                    </button>
